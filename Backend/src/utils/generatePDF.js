...
export async function generarPDFBuffer(xmlString) {
   ...
   doc.fontSize(9)
      .fillColor('#999')
      .font('Helvetica')
      .text('Software: ', 32, yPos, { continued: true, width: 530, align: 'center' });

   doc.font('Helvetica-Bold')
      .fillColor(primaryColor)
      .text('SysPyME', 45, yPos, { continued: true });
   ...
   doc.fontSize(9)
      .text(`© ${new Date().getFullYear()} Todos los derechos reservados.`, 40, yPos + 10, { width: 530, align: 'center' });

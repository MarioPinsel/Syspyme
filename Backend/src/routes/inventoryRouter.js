...
import { createProductValidation, addProductValidation, updateProductValidation, deleteProductValidation } from '../middleware/validators.js';
...
router.delete('/deleteProducts', deleteProductValidation, validate, deleteProductController)
